...
As long as current subtask needs **reasoning or coding or programming or using APIs**, you MUST let the **worker node with strong reasoning or coding capability** to do it. 
"""
)
