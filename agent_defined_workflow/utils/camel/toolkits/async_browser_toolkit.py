...
<detailed_plan>{detailed_plan}</detailed_plan>
    ...
    async def browse_url(
        self, task_prompt: str, start_url: str, round_limit: int = 8
    ) -> str:
        ...
        #get agent-permission.json
        #create AgentPermissionPolicy instance
        ...
        for i in range(round_limit):
            ...
            if "stop" in action_code:
                ...
                #if action_code is `click_id`
                #   element = ?
                #   allow = AgentPermissionPloicy("click_element",element)
