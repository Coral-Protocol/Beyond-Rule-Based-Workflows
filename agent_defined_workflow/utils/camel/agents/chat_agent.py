            ...
            if tool_call_requests := response.tool_call_requests:
                ...
                if (
                    ...
                    debug_content = f"""
                        ...
                        **STOP CALLING assistant again!!!**
                        **STOP CALLING assistant again!!!**
                        **STOP CALLING assistant again!!!**
                        
                        **Please provide a detailed summary of the tool call findings and immediately invoke send_message to report to information_flow_orchestrator and ask for support.**.
                       

                        Here is the tool calling history so far:
